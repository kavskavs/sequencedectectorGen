...
```sh
git clone git@github.com:kavskavs/sequencedectectorGen.git
cd sequencedectectorGen
```
...
#### Commit your changes
```sh
git commit -m 'Starting sequencedectectorGen'
...
```sh
mill sequencedectectorGen.test
```
